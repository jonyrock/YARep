...
<script type="text/javascript">
	...
	<%= Html.SliderStatic("/Content/images/slide5.jpg")%>
...
<div>
	...
	<div style="float:left; width:461px; ">
		<div style="background:url('/Content/Images/goods_title.jpg') no-repeat right; height:89px;
...
<br/>Сicé -пептидная косметика, не содержащая гормонов и парфюмированных отдушек, легкая, быстро проникающая в кожу   заботится обо всех: зрелых и молодых,  о  женщинах и   мужчинах! 
	...
	<div style="float:left; width:212px; margin:170px 0px 0px 75px">            
		<div style="width:195px; height:224px; margin:auto; background:url('/Content/Images/shop_all.jpg')">      
		</div>
	</div>
...
<p>Содержимое 30 мл достаточно для 70 - 90 применений.
	...
	<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_1.jpg')">      
		</div>
	</div>
	...
	<div style="width:100%; display:none;" id="slide1">
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
			<div style="width:88px; height:82px; margin:35px auto auto; background:url('/Content/Images/garant.jpg')"></div>      
		</div>
...
<p>Содержимое 30 мл достаточно для 70 - 90 применений.
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_2.jpg')"></div>
		</div>
		<div style="clear:both"></div>
...
<p>Содержимое 15 мл достаточно для 100 - 120 применений.
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_3.jpg')"></div>
		</div>
		<div style="clear:both"></div>
...
<p>Содержимое 150 мл достаточно для 20 - 30 применений.
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_4.jpg')"></div>
		</div>
		<div style="clear:both"></div>
...
<p>Содержимое 150 мл достаточно для 70 - 90 применений.
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_5.jpg')"></div>
		</div>
		<div style="clear:both"></div>
...
<p>Содержимое 50 мл достаточно для 30 - 40 применений.
	   ...
	   <div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_6.jpg')"></div>
		</div>
		<div style="clear:both"></div>
	...
	<div style="width:100%; display:none;" id="slide6">           
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
			<div style="width:88px; height:82px; margin:5px auto auto; background:url('/Content/Images/garant.jpg')"></div>      
		</div>
...
<p>Содержимое 15 мл достаточно для 100 - 120 применений.
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
		<div style="width:79px; height:249px; margin:auto; background:url('/Content/Images/shop_item_7.jpg')"></div>
		</div>
		<div style="clear:both"></div>
	...
	<div style="width:100%; display:none;" id="slide7">           
		...
		<div style="float:left; width:212px; margin:0px 0px 0px 75px">            
			<div style="width:170px; height:82px; margin:35px auto auto; background:url('/Content/Images/garant2.jpg')"></div>      
		</div>
...
<!-- /Сicé Омолаживающая сыворотка -->
	...
	<% Html.RenderPartial("HexMenu", "/Content/images/grad5.jpg"); %>
